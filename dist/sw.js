...
const CACHE = 'kompass-v20260519-5';
const STATIC = [
  '/',
  '/index.html',
  '/manifest.json'
...
self.addEventListener('fetch', e => {
  // Network-first for Supabase API calls — never serve from cache
  ...
  // Network-first for all other requests — always get fresh code, fall back to cache when offline
  e.respondWith(
